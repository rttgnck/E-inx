...
class ConnectionsActivity final : public CrossPlayActivity {
 public:
  ConnectionsActivity(GfxRenderer& renderer, MappedInputManager& mappedInput, const std::function<void()>& onBack)
      : CrossPlayActivity("Connections", renderer, mappedInput), onBack_(onBack) {}
